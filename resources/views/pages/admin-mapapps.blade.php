...
@section('content')
            ...
            <div class="d-flex flex-column align-items-center mt-5 mb-4" style="height: 65vh">
                <div class="d-flex justify-content-between" style="width: 95%">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="{{ route('admin.map-apps-user-create') }}">
                    ...
                    <tbody>
                        @forelse ($maps as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.map-apps-user-edit', $item->id) }}">
                                        <button type="button" class="btn btn-outline-primary">Ubah Data</button>
                                    </a>
                                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
                                        data-bs-target="#deleteModalMaps" data-id="{{ $item->id }}">
                                        Hapus Data
                                    </button>
                                </td>
                            </tr>
    ...
    <div class="modal fade" id="deleteModalMaps" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus hak otorisasi ini? Data yang dihapus tidak dapat dikembalikan.
                </div>
